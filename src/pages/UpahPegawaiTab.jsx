  ...
  return <div className="space-y-5">
    <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-3">
      <div>
        ...
        <p className="text-xs text-slate-600 mt-1">Perhitungan dinamis: UMK × (1 + KOEF + TMK), dengan tier berdasarkan minimum masa kerja.</p>
      </div>
